...
return {
  -- add a few keybindings
  {
    ...
    opts = function(_, opts)
      ...
      -- terminal
      maps.n["<Leader>tf"] = function() require("vscode").action "workbench.action.terminal.toggleTerminal" end
      maps.n["<C-'>"] = function() require("vscode").action "workbench.action.terminal.toggleTerminal" end
      maps.n["<Leader>tc"] = function() require("vscode").action "workbench.action.closePanel" end
